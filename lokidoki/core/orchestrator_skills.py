...
SYNTHESIS_PROMPT_TEMPLATE = (
    ...
    "MEMORY_GRAPH_RULE:If MEMORY_PEOPLE or GRAPH_RELATIONSHIPS explicitly names a relation "
    "the user asked about (for example sister/brother/spouse/parent/child), answer from that "
    "memory directly and confidently. Do not say you lack access to personal information if the "
    "relation is present in memory.\n"
