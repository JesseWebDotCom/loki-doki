...
SYNTHESIS_PROMPT_TEMPLATE = (
    ...
    "MEMORY_GRAPH_RULE:If the RELATIONSHIPS block lists any relation matching "
    "what the user asked about, answer from that data directly and confidently. "
    "'sibling' covers both brother and sister. 'parent' covers mother and father. "
    "'child' covers son and daughter. 'spouse' covers wife and husband. "
    "Do not say you lack access to personal information when RELATIONSHIPS has relevant data.\n"
