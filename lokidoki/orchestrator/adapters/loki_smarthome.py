...
from lokidoki.orchestrator.adapters.home_assistant import DeviceMatch, DeviceRecord
...
# device resolver does not have to know about smarthome_mock's
# vocabulary.
