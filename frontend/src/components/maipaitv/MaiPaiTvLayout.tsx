// MaiPai TV app shell: the always-dark cinema surface (same posture as MusicLayout /
...
export function MaiPaiTvLayout() {
  const { pathname } = useLocation()
  const isWatch = pathname.includes('/watch/')
  usePublishUIContext({ label: 'MaiPai TV', description: 'User is watching the MaiPai TV linear channels app.' })
