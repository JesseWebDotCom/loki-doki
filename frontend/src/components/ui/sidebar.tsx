    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar border-sidebar-border group-data-[side=left]:border-r group-data-[side=right]:border-l group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-lg"
        >
          {children}
        </div>
      </div>
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden transition-transform",
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-hidden transition-transform",
        "group-data-[collapsible=icon]:hidden",
        "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
        "after:absolute after:-inset-2 md:after:hidden",
        "[&>svg]:size-4 [&>svg]:shrink-0",
        showOnHover && "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 aria-expanded:opacity-100 md:opacity-0",
        className,
      )}
      {...props}
    />
...
export {
  ...
  SidebarMenuSkeleton, SidebarProvider, SidebarRail, SidebarSeparator, SidebarTrigger,
  useSidebar,
};
