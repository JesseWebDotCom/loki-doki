...
const TICKER_KEYFRAMES = '@keyframes dokitv-ticker { from { transform: translateX(0) } to { transform: translateX(-50%) } }'
          ...
          <div className="flex h-16 shrink-0 items-center overflow-hidden rounded-card border border-border/50 bg-card/50">
            ...
            <div className="relative min-w-0 flex-1 overflow-hidden">
              <div
                ...
                style={{ animation: `dokitv-ticker ${Math.round(tickerSeconds)}s linear infinite` }}
              >
                {tickerLoop.map((it, i) => (
