...
function HolidayRow({ h }: { h: HolidayItem }) {
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg px-2 py-1.5">
      <div className="flex flex-col items-center justify-center w-10 shrink-0 rounded-md bg-muted/70 py-1">
    ...
    return (
      <div className="rounded-xl border border-border/50 bg-card overflow-hidden text-sm">
        <div className="flex items-center gap-4 px-4 py-4">
          <div className="flex flex-col items-center justify-center w-16 shrink-0 rounded-lg bg-primary/10 py-2">
