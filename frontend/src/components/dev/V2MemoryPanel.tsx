...
import { dumpV2Memory, resetV2Memory } from '../../lib/api';
import type { V2MemoryDumpResponse } from '../../lib/api-types';
...
const V2MemoryPanel: React.FC<Props> = ({ refreshNonce }) => {
  const [dump, setDump] = useState<V2MemoryDumpResponse | null>(null);
