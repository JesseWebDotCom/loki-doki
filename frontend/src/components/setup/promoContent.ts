...
export const PROMO_SLIDES: PromoSlide[] = [
  ...
  },
  {
    ...
    blurb: 'Books downloads whole collections of classics and textbooks once and lets you read them forever - they work when nothing else does.',
  },
  {
    Icon: Globe,
    ...
    blurb: 'Millions of articles in Reference, ready the moment you ask - no connection, no waiting.',
  },
  {
    Icon: GraduationCap,
    ...
    blurb: 'Full Khan Academy and Crash Course lessons in Reference - math, science, and history, watched and read with zero signal.',
  },
  {
    Icon: Wrench,
    ...
    blurb: 'iFixit repair guides in Reference walk you through phones, appliances, and cars step by step, even off the grid.',
  },
  {
    Icon: Stethoscope,
    ...
    blurb: 'Trusted health and emergency guides in Reference stay available when you need them most, online or off.',
  },
  {
    Icon: Map,
...
export const PROMO_TIPS: string[] = [
  ...
  'Browse all of Wikipedia with no internet from the Reference app.',
  'Khan Academy and Crash Course are available offline - add them from the Reference app.',
