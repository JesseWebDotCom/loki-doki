...
export const ADMIN_SECTIONS: AdminSection[] = [
  ...
  },
  {
    ...
    subsections: [
      ...
      { id: 'addresses', label: 'Addresses', kind: 'anchor', anchorId: 'addresses',
        keywords: ['address', 'addresses', 'url', 'ip', 'hostname', 'dns', 'connect', 'server url', 'endpoint', 'failover', 'priority', 'order'],
        description: 'Every address your apps can use to reach this hub, and the order they try them' },
