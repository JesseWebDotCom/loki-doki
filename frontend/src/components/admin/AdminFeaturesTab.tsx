...
const ADMIN_CAPS: AdminCapDef[] = [
  ...
  { id: 'stem-audio',    label: 'Music Studio',    description: 'AI stem separation (Demucs) + tempo/key/chord analysis (Essentia) for the Music Studio: split any song into vocals, drums, bass and more. Managed Python venv; runs fully local. On Windows: stem separation only (Essentia has no Windows builds).', bytes: 2_500_000_000, requires: [],            icon: SlidersHorizontal },
