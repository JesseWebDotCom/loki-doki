...
import { createItem, listCollections, probe, type ReaderType } from '@/lib/reader/api'
...
export function ReaderSaveDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
  const qc = useQueryClient()
  const [type, setType] = useState<ReaderType>('offline')
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => { if (!o) onClose() }}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader><DialogTitle>Save to Reader</DialogTitle></DialogHeader>
