...
import { ArrowLeft, ExternalLink, RotateCw, Archive, Loader2, AlertTriangle } from 'lucide-react'
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        {item.archiveState === 'pending' || item.archiveState === 'fetching' ? (
          <div className="flex flex-col items-center gap-3 py-24 text-muted-foreground">
            ...
            <p>Saving this article for offline reading…</p>
          </div>
        ) : item.archiveState === 'failed' ? (
          <div className="flex flex-col items-center gap-3 py-24 text-muted-foreground">
            <AlertTriangle className="size-7 text-red-400" />
            <p>Couldn't extract this article.</p>
