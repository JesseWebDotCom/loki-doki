// The Doki TV hub: the channel dial. Every enabled channel as a card with its logo
...
import { fetchTvGuide, tvGlyph, type TvGuideChannel } from '@/lib/dokitv/api'
...
const GROUPS: Array<{ label: string; match: (n: number) => boolean }> = [
  ...
  { label: 'The Doki Network', match: (n) => n >= 60 },
]
...
export function DokiTvHomePage() {
