...
export const DEFAULT_COMPANIONS: SeedCompanion[] = [
  ...
  // ── Robo-eyes crew: classic robot personality archetypes, all eyes ────────────
  {
    ...
    seed: 'rivet-tidy',
    category: 'everyday',
    avatarConfig: { eyeColor: ['fbbf24'], eyeShape: ['circle'], glow: ['soft'] },
  ...
  },
  {
    ...
    seed: 'volt-input',
    category: 'everyday',
    avatarConfig: { eyeColor: ['22d3ee'], eyeShape: ['wide'], glow: ['strong'] },
  ...
  },
  {
    ...
    seed: 'iris-scan',
    category: 'everyday',
    avatarConfig: { eyeColor: ['60a5fa'], eyeShape: ['tall'], glow: ['strong'] },
  ...
  },
  {
    ...
    seed: 'tempo-beats',
    category: 'creative',
    avatarConfig: { eyeColor: ['a78bfa'], eyeShape: ['rounded'], glow: ['soft'] },
  ...
  },
  {
    ...
    seed: 'mopey-sigh',
    category: 'everyday',
    avatarConfig: { eyeColor: ['f8fafc'], eyeShape: ['tall'], glow: ['soft'] },
