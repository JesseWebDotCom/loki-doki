...
export const homeAssistantTool: Tool = {
  id: 'homeAssistant',
  name: 'Home Assistant',
  description: 'Control smart-home devices — lights, switches, fans, locks, thermostats, scenes, covers/garage — and check their state by natural-language command',
  offline: false,
  dataSources: [],
  passMessage: 'text',
  ...
  toolDefinition: {
    ...
    function: {
      name: 'homeAssistant',
      description: 'Control a smart-home device via Home Assistant, or check a device’s state. Use for any request to turn on/off, dim, set, lock/unlock, open/close, activate a scene, or ask whether a device is on/off/locked/open.',
      parameters: {
        type: 'object',
        required: ['text'],
        properties: {
