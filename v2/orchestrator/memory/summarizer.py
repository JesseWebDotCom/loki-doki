...
When a session closes the v2 pipeline queues an out-of-band summarization
...
:mod:`v2.orchestrator.memory.promotion` and is invoked from this module
...
from v2.orchestrator.memory.store import V2MemoryStore, _now

log = logging.getLogger("v2.orchestrator.memory.summarizer")
...
def summarize_session(
    ...
    *,
    ...
    from v2.orchestrator.memory.promotion import run_cross_session_promotion
