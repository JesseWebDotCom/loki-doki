"""
Candidate schemas for the v2 memory write path.
...
extractor that produces candidates from a parsed v2 chunk. M0 left this
...
- `predicate` is the closed-enum string from
  :mod:`v2.orchestrator.memory.predicates`. Gate 3 enforces it.
