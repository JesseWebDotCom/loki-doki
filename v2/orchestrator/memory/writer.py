"""
Memory writer — orchestrates the v2 write path.

The writer is the only public entry point for landing a candidate in the
durable v2 store. It runs Layer 1 (gate chain), Layer 2 (tier classifier),
...
from v2.orchestrator.memory.candidate import (
    CandidateRejection,
    MemoryCandidate,
)
from v2.orchestrator.memory.classifier import classify_candidate
from v2.orchestrator.memory.gates import GateChainResult, run_gate_chain
from v2.orchestrator.memory.predicates import is_immediate_durable
from v2.orchestrator.memory.promotion import consider_promotion
from v2.orchestrator.memory.store import V2MemoryStore, WriteOutcome, get_default_store
