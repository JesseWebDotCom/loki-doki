"""Per-chunk extraction for the v2 prototype.
...
from v2.orchestrator.core.types import ChunkExtraction, ParsedInput, RequestChunk
from v2.orchestrator.linguistics import DETERMINERS, PRONOUNS
