"""Stdlib ANSI trace console renderer for the v2 orchestrator.
...
Usage::
    ...
    from v2.orchestrator.observability.console import attach_console_renderer
    from v2.orchestrator.observability.tracing import start_trace
...
from v2.orchestrator.core.types import TraceData, TraceStep
