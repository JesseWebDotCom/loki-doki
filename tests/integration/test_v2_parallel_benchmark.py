...
from v2.orchestrator.execution.executor import register_handler
...
def _install_slow_handlers():
    ...
    """
    from v2.orchestrator.execution import executor as executor_module
...
@pytest.mark.anyio
async def test_v2_pipeline_parallel_path_is_faster_than_simulated_sequential():
