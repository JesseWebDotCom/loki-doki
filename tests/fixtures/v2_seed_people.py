...
Used by:
- ``tests/unit/test_v2_resolvers.py`` — passed explicitly to
...
- ``tests/integration/conftest.py`` — monkeypatched into
  ``v2.orchestrator.adapters.people_db._DEFAULT_ROSTER`` for the
...
from v2.orchestrator.adapters.people_db import PersonRecord
