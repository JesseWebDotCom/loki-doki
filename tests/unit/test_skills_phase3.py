...
class TestSearchWeb:
    ...
    def test_search_web_handler_exists(self):
        from lokidoki.orchestrator.skills.search_web import search_web
    ...
    async def test_search_web_extracts_query_from_params(self, monkeypatch):
        from lokidoki.orchestrator.skills import search_web as mod
...
class TestMovieAdapters:
    ...
    def test_movies_module_exists(self):
        mod = importlib.import_module("lokidoki.orchestrator.skills.movies")
        assert hasattr(mod, "lookup_movie")
        assert hasattr(mod, "search_movies")

    @pytest.mark.anyio
    async def test_lookup_movie_missing_title(self):
        from lokidoki.orchestrator.skills.movies import lookup_movie
    ...
    async def test_search_movies_missing_query(self):
        from lokidoki.orchestrator.skills.movies import search_movies
    ...
    async def test_lookup_movie_reads_params_title(self, monkeypatch):
        ...
        from lokidoki.orchestrator.skills import movies as mod
    ...
    def test_movies_uses_tmdb_and_wiki_skills(self):
        ...
        source = inspect.getsource(importlib.import_module("lokidoki.orchestrator.skills.movies"))
...
class TestPeopleRelationships:
    ...
    def test_module_exists(self):
        mod = importlib.import_module("lokidoki.orchestrator.skills.people_relationships")
        assert hasattr(mod, "lookup_relationship")
        assert hasattr(mod, "list_family")

    @pytest.mark.anyio
    async def test_lookup_relationship_empty_db(self):
        from lokidoki.orchestrator.skills.people_relationships import lookup_relationship
        result = await lookup_relationship({"chunk_text": "who is my brother", "params": {}})
        assert result["success"] is False

    @pytest.mark.anyio
    async def test_list_family_empty_db(self):
        from lokidoki.orchestrator.skills.people_relationships import list_family
    ...
    async def test_lookup_relationship_with_data(self, monkeypatch):
        ...
        from lokidoki.orchestrator.skills import people_relationships as mod
...
class TestTVEpisodeDetail:
    ...
    def test_handler_exists(self):
        from lokidoki.orchestrator.skills.tv_show import get_episode_detail
    ...
    async def test_episode_detail_formats_correctly(self, monkeypatch):
        from lokidoki.core.skill_executor import MechanismResult
        from lokidoki.orchestrator.skills import tv_show as mod
...
class TestPeopleResolverWiring:
    ...
    def test_lookup_relationship_in_people_capabilities(self):
        from lokidoki.orchestrator.resolution.people_resolver import PEOPLE_CAPABILITIES
...
class TestDerivationsWiring:
    ...
    def test_social_capabilities_include_relationships(self):
        from lokidoki.orchestrator.pipeline.derivations import _SOCIAL_CAPABILITIES
...
class TestRetirementDocumented:
    ...
    def test_open_meteo_is_sole_weather_provider(self):
        ...
        source = inspect.getsource(importlib.import_module("lokidoki.orchestrator.skills.weather"))
