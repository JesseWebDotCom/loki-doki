...
class TestDynamicHandlerMap:
    ...
    def test_no_hardcoded_skill_handler_map_in_executor(self):
        ...
        import lokidoki.orchestrator.execution.executor as executor_mod
    ...
    def test_adding_skill_only_needs_registry_entry(self):
        ...
        assert mod == "lokidoki.orchestrator.skills.weather"
        assert attr == "handle"
...
class TestRealAdapters:
    ...
    def test_resolver_uses_loki_smarthome_adapter_by_default(self):
        ...
        import inspect
        from lokidoki.orchestrator.resolution import resolver
    ...
    def test_resolver_accepts_injected_adapter_via_context(self):
        ...
        from lokidoki.orchestrator.adapters.home_assistant import DeviceRecord, HomeAssistantAdapter
        from lokidoki.orchestrator.core.types import ChunkExtraction, RequestChunk, RouteMatch
        from lokidoki.orchestrator.resolution.resolver import resolve_chunks
    ...
    def test_device_resolver_protocol_type(self):
        ...
        import inspect
        from lokidoki.orchestrator.resolution import device_resolver
...
class TestParamsFromPipeline:
    ...
    def test_weather_reads_params_not_chunk_text(self):
        ...
        import inspect
        from lokidoki.orchestrator.skills import weather
    ...
    def test_time_in_location_reads_params_first(self):
        ...
        import inspect
        from lokidoki.orchestrator.skills import time_in_location
