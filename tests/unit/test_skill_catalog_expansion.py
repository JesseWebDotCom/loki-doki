...
async def test_holidays_adapter_get_holiday_matches_name(monkeypatch):
    from lokidoki.orchestrator.skills import holidays as adapter
...
async def test_finance_adapter_converts_currency(monkeypatch):
    from lokidoki.orchestrator.skills import finance as adapter
...
async def test_time_until_handles_holiday_lookup(monkeypatch):
    from lokidoki.orchestrator.skills import holidays as holidays_adapter
    from lokidoki.orchestrator.skills import time_until as adapter
