...
from v2.orchestrator.pipeline.derivations import (
    derive_need_flags,
...
class TestV2VsV1:
    ...
    def test_v2_pipeline_has_no_decomposer_import(self):
        ...
        """
        pipeline = Path(__file__).resolve().parent.parent.parent / "v2" / "orchestrator" / "core" / "pipeline.py"
