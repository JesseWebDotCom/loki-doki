...
class TestPlayerStats:
    ...
    def test_handler_exists_and_importable(self):
        mod = importlib.import_module("lokidoki.orchestrator.skills.sports_api")
        fn = getattr(mod, "get_player_stats")
        assert asyncio.iscoroutinefunction(fn)

    def test_missing_player_returns_error(self):
        from lokidoki.orchestrator.skills.sports_api import get_player_stats
...
class TestSubstituteIngredient:
    ...
    def test_table_has_35_plus_entries(self):
        from lokidoki.orchestrator.skills.food import _SUBS
    ...
    def test_handler_finds_expanded_entries(self):
        from lokidoki.orchestrator.skills.food import substitute_ingredient
...
class TestLookupFactProperties:
    ...
    def test_property_count(self):
        from lokidoki.orchestrator.skills.people_facts import _FACT_TO_PROPERTY
...
class TestTimeInLocationCities:
    ...
    def test_city_count(self):
        from lokidoki.orchestrator.skills.time_in_location import _CITY_TO_TZ
    ...
    def test_new_cities_resolve(self):
        ...
        from lokidoki.orchestrator.skills.time_in_location import _resolve_tz
    ...
    def test_handler_new_city(self):
        from lokidoki.orchestrator.skills.time_in_location import handle
...
class TestLLMSkillContract:
    ...
    def test_stub_has_source_title(self):
        from lokidoki.orchestrator.skills.llm_skills import generate_email
    ...
    def test_empty_request_fails(self):
        from lokidoki.orchestrator.skills.llm_skills import code_assistance
    ...
    def test_contract_docstring(self):
        import lokidoki.orchestrator.skills.llm_skills as mod
...
class TestSourceTransparency:
    ...
    def test_health_symptom_has_source(self):
        ...
        from lokidoki.orchestrator.skills.health import look_up_symptom
    ...
    def test_health_medication_has_source(self):
        from lokidoki.orchestrator.skills.health import check_medication
    ...
    def test_navigation_directions_has_source(self):
        from lokidoki.orchestrator.skills.navigation import get_directions
    ...
    def test_navigation_nearby_has_source(self):
        from lokidoki.orchestrator.skills.navigation import find_nearby
    ...
    def test_food_nutrition_has_source(self):
        from lokidoki.orchestrator.skills.food import get_nutrition
    ...
    def test_travel_flight_has_source(self):
        from lokidoki.orchestrator.skills.travel import get_flight_status
    ...
    def test_sports_scores_have_source(self):
        from lokidoki.orchestrator.skills.sports_api import get_score
    ...
    def test_sports_standings_have_source(self):
        from lokidoki.orchestrator.skills.sports_api import get_standings
    ...
    def test_sports_schedule_has_source(self):
        from lokidoki.orchestrator.skills.sports_api import get_schedule
