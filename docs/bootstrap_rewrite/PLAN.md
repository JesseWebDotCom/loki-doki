...
| 5 | [LLM engines (MLX, llama.cpp Vulkan/CPU) + provider layer](chunk-5-llm-engines.md) | done    | 77c8b5a |
...
| 8 | [Windows support (run.bat + win branches)](chunk-8-windows.md)          | done    | PENDING |
