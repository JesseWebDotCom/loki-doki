---
title: Shopping
description: Track prices across Amazon, Walmart, Target, and more, get price-drop alerts, browse today's deals, and clip coupons.
sidebar:
  order: 20
---

Shopping is your household's private price tracker. Watch products across major retailers, get told the moment a price drops, and browse deals and coupons, all from one page. Nothing you track is sold to anyone; it's just for you.
...
A **Today's Deals** feed surfaces what's actually worth a look right now, pulled from Slickdeals. Alongside it, coupon links for Amazon, Walmart, Target, Home Depot, Lowe's, Best Buy, and eBay make it easy to clip a discount before you check out.
...
You don't have to open the app to use any of this. Ask your companion to track a link, check whether something's at its best price, or tell you what's on sale, and it reaches for Shopping on your behalf.

## A Note on the Internet

Shopping needs a connection: prices, deals, and coupons are all fetched live from retailers and can't be cached ahead of time.
