...
- **Per-user feature access**: the admin decides which features each person can see and use
- **Content filtering per user**, keeping responses family-friendly across chat, images, and video
- **No data collection, no ads, no tracking**: nothing your family says is harvested, profiled, or sold

See [Privacy & Content Controls](../privacy/) for how the safeguards work day to day.

## Say What You Want. Generate What You Want.
...
- **[Chat](../features/chat/)** with a local AI that remembers you and can look things up, check the weather, and more, without your words leaving the house
...
Head to [Getting Started](../getting-started/) to log in, set up your account, and explore the app.
