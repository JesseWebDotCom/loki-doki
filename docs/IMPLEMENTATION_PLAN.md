...
| **C14.5** | Conversational coherence (history, source quality, context) | C14 | `chunks/chunk-14.5.md` | Medium | **complete** |
| **C15** | Skills admin & settings pages: v2 registry rewire | C13 | `chunks/chunk-15.md` | Medium | **complete** |
